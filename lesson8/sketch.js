...
function setup() {
    ...
    chart01 = new ScatterPlotChart(data4, "Goals scored vs goals conceded in the 20/21 season", "Goals conceded", "Goals scored");
    chart02 = new ScatterPlotChart(data3, "Clean sheets vs Games won in the 20/21 season", "Games Won", "Clean Sheets");
    chart03 = new HorizontalBarChart(data, "Money spent during transfer winows in millions for the 20/21 season", "Money Spent", "Team");
    chart04 = new StackedBarChart(data2, "Amount of home and away goals scored in the 20/21 season", "Team", "Total goals scored");
